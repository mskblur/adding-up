...
const rl = readline.createInterface({ 'input':rs, 'output': {}}); //第一引数はreadStream,第二引数にwriteStream。今回は読み込みのみのため第二引数には空オブジェクトを渡しています。

const map = new Map(); // key: 都道府県 value: 人口
